export const My_Project = [
  {
    ...
    overal:"Developed a chatbot using OCR and LLama 2 for efficient healthcare document search, optimizing performance and accuracy.",
    description:
  ...
  },
  {
    ...
    overal:"Analyzed ML techniques for MRI brain tumor classification, developing an ensemble model achieving 0.956 accuracy, enhancing medical imaging.",
    description:
  ...
  },
  {
    ...
    overal:"Developed real-time facial emotion recognition models with CNNs, achieving 90% accuracy and under 100ms per frame analysis.",
    description:
  ...
  },
  {
    ...
    overal:"Developed Python regression models for wine quality prediction, achieving 0.634 RMSE and identifying key quality drivers through analysis.",
    description:
  ...
  },
  {
    ...
    overal:"Analyzed 10,000 esports earnings data, revealing industry trends using Python for modeling and Tableau for visualization.",
    description:
